...
struct ExampleTests {
    @Test func `rotated box produces correct geometry`() async throws {
    ...
    @Test func `twisted extrusion with boolean subtraction produces correct geometry`() async throws {
    ...
    @Test func `stacked star shapes produce correct geometry`() async throws {
    ...
    @Test func `star shape swept along bezier path produces correct geometry`() async throws {
