...
internal enum LiveLinkFraming {
    ...
    static func makeFrame(for message: LiveLinkMessage) throws -> Data {
    ...
    static func parseHeader(_ data: Data) throws -> Int {
    ...
    static func decodeMessage(_ data: Data) throws -> LiveLinkMessage {
