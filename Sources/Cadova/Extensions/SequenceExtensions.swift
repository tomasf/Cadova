...
extension Sequence where Element: Sendable {
    ...
    @_specialize(exported: false, where Self == [any Geometry<D2>], T == _BuildResult<D2>)
    @_specialize(exported: false, where Self == [any Geometry<D3>], T == _BuildResult<D3>)
    @_specialize(exported: false, where Self == [_BuildResult<D2>], T == Measurements<D2>)
    @_specialize(exported: false, where Self == [_BuildResult<D3>], T == Measurements<D3>)
