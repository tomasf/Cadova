...
public extension EnvironmentValues {
    ...
    ///
    /// This property retrieves the tolerance setting from the environment. If not explicitly set, the tolerance defaults to 0. Tolerance can be understood as the permissible limit or limits of variation in measurements, dimensions, or physical properties of a geometry. While the tolerance value itself does not directly influence geometry creation in Cadova, it can be utilized by your own models to adjust generation of geometries according to the specified tolerance.
    ///
    ...
    ///
    /// This method modifies the tolerance setting of an environment. Tolerance can be understood as the permissible limit or limits of variation in measurements, dimensions, or physical properties of a geometry. While the tolerance value itself does not directly influence geometry creation in Cadova, it can be utilized by your own models to adjust generation of geometries according to the specified tolerance.
    ///
