...
public extension Geometry2D {
    ...
    /// Defines an anchor point on this geometry.
    ///
    /// Use this method to mark a specific coordinate system as an anchor. This anchor can then be used to position
    /// and orient the geometry tree by aligning the saved transform to the origin. The anchor captures the current
    /// transformation state, optionally applying an additional alignment, offset and rotation.
    ///
    /// - Parameters:
    ///   - anchor: The `Anchor` to define on this geometry.
    ///   - alignment: One or more alignment options specifying where on the geometry the anchor should be located.
    ///     If no alignment is specified, the origin is used.
    ...
    /// system. It's used to position this geometry based on the location and orientation of an anchor defined inside
    /// this geometry.
    ///
...
public extension Geometry3D {
    ...
    /// transformation state, optionally applying an additional alignment, offset, direction and rotation.
    ///
    /// - Parameters:
    ///   - anchor: The `Anchor` to define on this geometry.
