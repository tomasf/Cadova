...
public extension EnvironmentValues {
    ...
    enum Operation: Sendable {
        ...
        case addition
        /// Represents the subtraction of geometries, typically used for creating holes or negative spaces within
        /// another geometry.
        case subtraction

        /// Toggles the operation between addition and subtraction.
        ///
        /// Applying this operator to an operation inverts it: if it's `.addition`, it becomes `.subtraction`, and
        /// vice versa.
    ...
    /// Accesses the current operation state from the environment, determining if a geometry is being added to or
    /// subtracted from a composite structure.
    ///
