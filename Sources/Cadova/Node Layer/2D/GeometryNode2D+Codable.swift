...
extension GeometryNode2D: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        case .boolean:
            ...
            let children = try container.decode([GeometryNode2D].self, forKey: .children)
            self.init(.boolean(children, type: type))
        case .transform:
            let body = try container.decode(GeometryNode2D.self, forKey: .body)
        ...
        case .offset:
            self.init(.offset(
                try container.decode(GeometryNode2D.self, forKey: .body),
