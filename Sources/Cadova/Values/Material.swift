...
///
/// Materials can optionally include a `name`, which is stored in the 3MF file and may assist in debugging or
/// future workflows.
///
public struct Material: Hashable, Sendable, Codable {
    ...
    ///
    /// These allow customization of how the material reflects light, including metallic surfaces and glossy or
    /// specular highlights.
    ///
